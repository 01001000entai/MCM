...
class Human_Capital_Network2():
    ...
    def invite(self, k):
        if self.level_of_position[k] <= 1:
            if self.number_of_invite > 0*0.1/12:
                return
            self.number_of_invite += 1
            self.position[k] = Worker(self.level_of_position[k], name_of_department = self.department_of_position[k], new=True)
            self.cost += ct.cost_of_recruitment[self.level_of_position[k]]
...
hrn2 = Human_Capital_Network2(3000)
...
plt.plot(range(l),pro[0],label="type A",color="r",marker='s')
plt.plot(range(l),pro[1],label="type B",color="b",marker='p')
plt.legend(loc = 'upper left')
#plt.plot(range(l),num,label="number",color="yellow")
#plt.show()
plt.savefig("dif_pro.png")

plt.cla()
plt.figure(figsize=(9,6))
plt.plot(range(l),cost[0],label="type A",color="r",marker='s')
plt.plot(range(l),cost[1],label="type B",color="b",marker='p')
plt.legend(loc = 'lower left')
#plt.plot(range(l),num,label="number",color="yellow")
#plt.show()
plt.savefig("dif_cost.png")

plt.cla()
plt.figure(figsize=(9,6))
plt.plot(range(l),num[0],label="type A",color="r",marker='s')
plt.plot(range(l),num[1],label="type B",color="b",marker='p')
plt.plot(range(l),[370*0.8 for i in range(l)],'b--',label="80\%  staff")
plt.legend(loc = 'lower left')
#plt.plot(range(l),num,label="number",color="yellow")
#plt.show()
plt.savefig("dif_num.png")
