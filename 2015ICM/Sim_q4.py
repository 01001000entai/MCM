...
class Human_Capital_Network():
    ...
    def run(self, rate_of_leave):
        ...
        proformance = 0
        unhealthy = 0
        rate_of_leave = 3000.0/self.o * rate_of_leave
        print rate_of_leave
        self.number_of_invite = 0
        self.cost = 0
...
for i in range(l):
    ...
    [uh[1][i], pro[1][i], num[1][i], cost[1][i]] = hrn2.run(0.25/12)
    [uh[2][i], pro[2][i], num[2][i], cost[2][i]] = hrn3.run(0.35/12)
print num
#draw
plt.cla()
plt.figure(figsize=(9,6))
plt.plot(range(l),pro[0],label="churn rate=18%",color="r",marker='s')
plt.plot(range(l),pro[1],label="churn rate=25%",color="b",marker='p')
plt.plot(range(l),pro[2],label="churn rate=35%",color="g",marker='*')
plt.legend(loc = 'upper left')
plt.xlabel('Month')
plt.ylabel('Productivity')
#plt.plot(range(l),num,label="number",color="yellow")
#plt.show()
plt.savefig("churn_pro.png")

plt.cla()
plt.figure(figsize=(9,6))
plt.plot(range(l),cost[0],label="churn rate=18%",color="r",marker='s')
plt.plot(range(l),cost[1],label="churn rate=25%",color="b",marker='p')
plt.plot(range(l),cost[2],label="churn rate=35%",color="g",marker='*')
plt.legend(loc = 'lower left')
plt.xlabel('Month')
plt.ylabel('Total Expense')
#plt.plot(range(l),num,label="number",color="yellow")
#plt.show()
plt.savefig("churn_cost.png")

plt.cla()
plt.figure(figsize=(9,6))
plt.plot(range(l),num[0],label="churn rate=18%",color="r",marker='s')
plt.plot(range(l),num[1],label="churn rate=25%",color="b",marker='p')
plt.plot(range(l),num[2],label="churn rate=35%",color="g",marker='*')
plt.plot(range(l),[370*0.8 for i in range(l)],'b--',label="80\%  staff")
plt.legend(loc = 'lower left')
plt.xlabel('Month')
plt.ylabel('Number of Staff')
#plt.plot(range(l),num,label="number",color="yellow")
#plt.show()
plt.savefig("churn_num.png")
