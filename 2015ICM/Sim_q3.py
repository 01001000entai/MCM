...
plt.plot(range(l),pro[0],label="sigma=3000",color="r",marker='s')
plt.plot(range(l),pro[1],label="sigma=6000",color="b",marker='p')
plt.plot(range(l),pro[2],label="sigma=10000",color="g",marker='*')
plt.legend()
...
plt.cla()
plt.figure(figsize=(9,6))
plt.plot(range(l),cost[0],label="sigma=3000",color="r",marker='s')
plt.plot(range(l),cost[1],label="sigma=6000",color="b",marker='p')
plt.plot(range(l),cost[2],label="sigma=10000",color="g",marker='*')
plt.legend()
#plt.plot(range(l),num,label="number",color="yellow")
#plt.show()
...
plt.cla()
plt.figure(figsize=(9,6))
plt.plot(range(l),num[0],label="sigma=3000",color="r",marker='s')
plt.plot(range(l),num[1],label="sigma=6000",color="b",marker='p')
plt.plot(range(l),num[2],label="sigma=10000",color="g",marker='*')
